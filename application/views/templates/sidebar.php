    ...
    <ul class="sidebar-menu" data-widget="tree">
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          ...
          <li><a href="<?php echo site_url() ?>/Pelanggan/index"><i class="fa fa-circle-o"></i> Pelanggan</a></li>
          <li><a href="<?php echo site_url() ?>/User/index"><i class="fa fa-circle-o"></i> User</a></li>
        </ul>
      </li>
      <li class="treeview">
        <a href="#">
